...
<form method="post" class="form-grid" style="max-width:640px;">
  ...
  <p style="grid-column:1/-1;font-size:12px;color:var(--muted);margin:-6px 0 0;">
    Дешёвая схема без своего зарегистрированного имени отправителя —
    от 25 коп/SMS. api_id для SMS.ru — в личном кабинете, Настройки → API.
  </p>
  ...
  <label class="field">API-ключ (api_id для SMS.ru)
